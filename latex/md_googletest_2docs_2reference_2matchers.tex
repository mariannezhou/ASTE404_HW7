...
A {\bfseries{matcher}} matches a {\itshape single} argument. You can use it inside {\ttfamily \doxylink{gmock-spec-builders_8h_a5b12ae6cf84f0a544ca811b380c37334}{ON\+\_\+\+CALL()}} or {\ttfamily \doxylink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{EXPECT\+\_\+\+CALL()}}, or use it to validate a value directly using two macros\+:
...
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily \doxylink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{EXPECT\+\_\+\+THAT(actual\+\_\+value, matcher)}}   &Asserts that {\ttfamily actual\+\_\+value} matches {\ttfamily matcher}.    \\\cline{1-2}
{\ttfamily \doxylink{gmock-matchers_8h_a41d888579850c16583baea33ee8d057e}{ASSERT\+\_\+\+THAT(actual\+\_\+value, matcher)}}   &The same as {\ttfamily \doxylink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{EXPECT\+\_\+\+THAT(actual\+\_\+value, matcher)}}, except that it generates a {\bfseries{fatal}} failure.   \\\cline{1-2}
\end{longtabu}


\{\+: .callout .warning\} {\bfseries{WARNING\+:}} Equality matching via {\ttfamily \doxylink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{EXPECT\+\_\+\+THAT(actual\+\_\+value, expected\+\_\+value)}} is supported, however note that implicit conversions can cause surprising results. For example, {\ttfamily EXPECT\+\_\+\+THAT(some\+\_\+bool, "{}some string"{})} will compile and may pass unintentionally.

{\bfseries{BEST PRACTICE\+:}} Prefer to make the comparison explicit via {\ttfamily \doxylink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{EXPECT\+\_\+\+THAT(actual\+\_\+value, Eq(expected\+\_\+value))}} or {\ttfamily \doxylink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\+\_\+\+EQ(actual\+\_\+value, expected\+\_\+value)}}.

Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily \doxylink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \doxylink{namespacetesting}{testing}} namespace unless otherwise noted.\hypertarget{md_googletest_2docs_2reference_2matchers_autotoc_md254}{}\doxysection{\texorpdfstring{Wildcard}{Wildcard}}\label{md_googletest_2docs_2reference_2matchers_autotoc_md254}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
