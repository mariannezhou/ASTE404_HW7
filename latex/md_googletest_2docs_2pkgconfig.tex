...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily \doxylink{sample3__unittest_8cc}{samples/sample3\+\_\+unittest.\+cc}}.\hypertarget{md_googletest_2docs_2pkgconfig_autotoc_md222}{}\doxysubsection{\texorpdfstring{CMake}{CMake}}\label{md_googletest_2docs_2pkgconfig_autotoc_md222}
